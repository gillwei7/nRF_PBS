...
#define DEVICE_NAME                     "BLE_HID"                             /**< Name of device. Will be included in the advertising data. */
...
static void on_adv_evt(ble_adv_evt_t ble_adv_evt)
{
    ...
    switch (ble_adv_evt)
    {
        ...
        case BLE_ADV_EVT_WHITELIST_REQUEST:
        {
            ...
            whitelist.addr_count = 2;//BLE_GAP_WHITELIST_ADDR_MAX_COUNT;
            whitelist.irk_count  = 2;//BLE_GAP_WHITELIST_IRK_MAX_COUNT; 
